...
* `target_user`: Extract username if SU01.
* `program_name`: Extract program name if SE38.
...
User: "run se38 to create a program named ZTEST_BOT"
{"intent": "sap", "output": {"action": "gui", "tcode": "SE38", "program_name": "ZTEST_BOT"}}
